...
If you want to open a PR on Barkis to update the documentation, please follow the guidelines in the [`CONTRIBUTING.md`](https://github.com/barkisnet/barkis/tree/master/CONTRIBUTING.md)
...
1. Execute the following command at the root directory to install the swagger-ui generate tool.
    ...
    ```
2. Edit API docs
    1. Directly Edit API docs manually: `cmd/barkiscli/swagger-ui/swagger.yaml`.
    2. Edit API docs within the [Swagger Editor](https://editor.swagger.io/). Please refer to this [document](https://swagger.io/docs/specification/2-0/basic-structure/) for the correct structure in `.yaml`.
3. Download `swagger.yaml` and replace the old `swagger.yaml` under fold `cmd/barkiscli/swagger-ui`.
4. Compile barkiscli
    ```bash
    make install
    ```
